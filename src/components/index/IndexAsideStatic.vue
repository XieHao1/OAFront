...
.index-aside {
  ...
  .el-menu-demo {
    ...
    & > .el-menu-item {
      ...
      border-width: 0;
      border-style: solid;
      border-color: rgb(122, 162, 215) !important;
      background-color: rgb(122, 162, 215) !important;
    ...
    & /deep/ .el-submenu__title {
      ...
      border-width: 0;
      border-style: solid;
      border-color: rgb(38, 54, 75) !important;
      background-color: rgb(122, 162, 215) !important;
      box-shadow: 0 0 6px rgba(255, 255, 255, 0);
      box-sizing: initial;
      display: flex;
