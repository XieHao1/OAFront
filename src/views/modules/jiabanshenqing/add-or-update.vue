  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="date" v-if="type!='info'" label="加班时间" prop="jiabanshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jiabanshijian"
                type="date"
                :readonly="ro.jiabanshijian"
                placeholder="加班时间">
            </el-date-picker>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" v-if="ruleForm.jiabanshijian" label="加班时间" prop="jiabanshijian">
              <el-input v-model="ruleForm.jiabanshijian"
                        placeholder="加班时间" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="加班时长" prop="jiabanshizhang">
            <el-input v-model="ruleForm.jiabanshizhang"
                      placeholder="加班时长" clearable :readonly="ro.jiabanshizhang"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="加班时长" prop="jiabanshizhang">
              <el-input v-model="ruleForm.jiabanshizhang"
                        placeholder="加班时长" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
          <el-form-item class="textarea" v-if="type!='info'" label="加班事由" prop="jiabanshiyou">
            <el-input
                style="min-width: 200px; max-width: 600px;"
                type="textarea"
                :rows="8"
                placeholder="加班事由"
                v-model="ruleForm.jiabanshiyou">
            </el-input>
          </el-form-item>
          <div v-else>
            <el-form-item v-if="ruleForm.jiabanshiyou" label="加班事由" prop="jiabanshiyou">
              <span>{{ ruleForm.jiabanshiyou }}</span>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
  ...
  data() {
    ...
    return {
      addEditForm: {
        ...
        "inputFontSize": "14px",
        "textareaBgColor": "#fff",
        "btnSaveFontSize": "18px",
        "textareaBorderRadius": "0",
        "uploadBgColor": "#fff",
        "textareaBorderStyle": "solid",
        "btnCancelWidth": "145px",
        "textareaHeight": "120px",
        "dateBgColor": "#fff",
        "btnSaveBorderRadius": "44px",
        "uploadLableFontSize": "14px",
        "textareaBorderWidth": "1px",
        "inputLableColor": "rgba(0, 0, 0, 1)",
        "addEditBoxColor": "rgba(255, 255, 255, 1)",
        "dateIconFontSize": "14px",
        "btnSaveBgColor": "rgba(237, 247, 255, 1)",
        "uploadIconFontColor": "#8c939d",
        "textareaBorderColor": "rgba(112, 112, 112, 1)",
        "btnCancelBgColor": "rgba(232, 232, 232, 1)",
        "selectLableColor": "rgba(0, 0, 0, 1)",
        ...
        "btnCancelHeight": "50px",
        "inputHeight": "40px",
        "btnCancelFontColor": "rgba(112, 112, 112, 1)",
        "dateBorderColor": "rgba(112, 112, 112, 1)",
        "dateIconFontColor": "#C0C4CC",
        "uploadBorderStyle": "solid",
        "dateBorderStyle": "solid",
        "dateLableColor": "rgba(0, 0, 0, 1)",
        "dateFontSize": "14px",
        ...
        "uploadHeight": "148px",
        "textareaLableColor": "rgba(0, 0, 0, 1)",
        "textareaLableFontSize": "14px",
        "btnCancelFontSize": "18px",
        "inputBorderStyle": "solid",
        "btnCancelBorderRadius": "44px",
        "inputBgColor": "#fff",
        "inputLableFontSize": "14px",
        "uploadLableColor": "rgba(0, 0, 0, 1)",
        "uploadBorderRadius": "0",
        "btnSaveHeight": "50px",
        "selectBgColor": "#fff",
        "btnSaveWidth": "145px",
        "selectIconFontSize": "14px",
        "dateHeight": "40px",
        "selectBorderColor": "rgba(112, 112, 112, 1)",
        "inputBorderColor": "rgba(112, 112, 112, 1)",
        "uploadBorderColor": "rgba(112, 112, 112, 1)",
        "textareaFontColor": "rgba(0, 0, 0, 1)",
        "selectBorderWidth": "1px",
        "dateFontColor": "rgba(0, 0, 0, 1)",
    ...
    init(id, type) {
      ...
      if (this.type == 'info' || this.type == 'else') {
        ...
        for (var o in obj) {
          ...
          if (o == 'jiabanshijian') {
            this.ruleForm.jiabanshijian = obj[o];
            this.ro.jiabanshijian = true;
            continue;
          }
          if (o == 'jiabanshizhang') {
          ...
          if (o == 'jiabanshiyou') {
            this.ruleForm.jiabanshiyou = obj[o];
            this.ro.jiabanshiyou = true;
            continue;
          }
        }
      }
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                if (data.data.total >= crossoptnum) {
                  ...
                  this.$http({
                    url: `jiabanshenqing/${!this.ruleForm.id ? "save" : "update"}`,
                    method: "post",
                    data: this.ruleForm
                  }).then(({data}) => {
                    if (data && data.code === 0) {
                      this.$message({
                        ...
                        onClose: () => {
                          ...
                          this.parent.jiabanshenqingCrossAddOrUpdateFlag = false;
                          this.parent.search();
