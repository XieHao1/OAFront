    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row  :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
              <el-form-item :label="contents.inputTitle == 1 ? '发放时间' : ''">
                  <el-date-picker
                      v-model="searchForm.fafangshijianstart"
                      type="date"
			...
			format="yyyy-MM-dd"
                  ...
                  至
                  <el-date-picker
                      v-model="searchForm.fafangshijianend"
                      type="date"
			value-format="yyyy-MM-dd" 
			format="yyyy-MM-dd"
                      placeholder="发放时间结束">
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.fafangshijianstart!='' && this.searchForm.fafangshijianstart!=undefined ){
            params['fafangshijianstart'] = this.searchForm.fafangshijianstart
          }
          if(this.searchForm.fafangshijianend!='' && this.searchForm.fafangshijianend!=undefined){
            params['fafangshijianend'] = this.searchForm.fafangshijianend
          }
