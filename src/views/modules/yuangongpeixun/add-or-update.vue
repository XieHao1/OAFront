    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="培训内容" prop="peixunneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.peixunneirong" label="培训内容" prop="peixunneirong">
                    <span>{{ruleForm.peixunneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yuangongpeixun/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yuangongpeixunCrossAddOrUpdateFlag = false;
						 this.parent.search();
