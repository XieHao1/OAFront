    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="招聘要求" prop="zhaopinyaoqiu">
          <el-input v-model="ruleForm.zhaopinyaoqiu" 
              placeholder="招聘要求" clearable  :readonly="ro.zhaopinyaoqiu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招聘要求" prop="zhaopinyaoqiu">
              <el-input v-model="ruleForm.zhaopinyaoqiu" 
                placeholder="招聘要求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="招聘流程" prop="zhaopinliucheng">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhaopinliucheng" label="招聘流程" prop="zhaopinliucheng">
                    <span>{{ruleForm.zhaopinliucheng}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhaopinjihua/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhaopinjihuaCrossAddOrUpdateFlag = false;
						 this.parent.search();
