    ...
    <div class="container">
      <div class="login-form">
        ...
        <el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
          ...
          <!-- <div v-if="tableName=='yuangong'" class="input-group">
             <div class="label">员工手机</div>
             <div class="input-container">
               <input v-model="ruleForm.yuangongshouji" class="input" type="text" placeholder="员工手机">
             </div>
           </div> -->
          <el-form-item label="员工手机" class="input" v-if="tableName=='yuangong'">
            <el-input v-model="ruleForm.yuangongshouji" autocomplete="off" placeholder="员工手机"/>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if (`yuangong` == this.tableName && this.ruleForm.jibengongzi && (!this.$validate.isNumber(this.ruleForm.jibengongzi))) {
